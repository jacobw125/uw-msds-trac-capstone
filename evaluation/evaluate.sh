...
python3 01_report_performance.py ../combined_data/30min/xval.tsv.gz ../predictions/svm_30min_combined_xval.txt trip_start_hr_30 svm_30min_combined | tee svm_30min_combined/perf.txt

mkdir svm_30min_winter
python3 01_report_performance.py ../winter_data/aggregates/30min/xval.tsv.gz ../predictions/svm_30min_winter_xval.txt trip_start_hr_30 svm_30min_winter | tee svm_30min_winter/perf.txt

mkdir svm_30min_summer
python3 01_report_performance.py ../summer_data/aggregates/30min/xval.tsv.gz ../predictions/svm_30min_summer_xval.txt trip_start_hr_30 svm_30min_summer | tee svm_30min_summer/perf.txt

# 15m
mkdir svm_15min_combined
python3 01_report_performance.py ../combined_data/15min/xval.tsv.gz ../predictions/svm_15min_combined_xval.txt trip_start_hr_15 svm_15min_combined | tee svm_15min_combined/perf.txt

mkdir svm_15min_winter
python3 01_report_performance.py ../winter_data/aggregates/15min/xval.tsv.gz ../predictions/svm_15min_winter_xval.txt trip_start_hr_15 svm_15min_winter | tee svm_15min_winter/perf.txt

mkdir svm_15min_summer
python3 01_report_performance.py ../summer_data/aggregates/15min/xval.tsv.gz ../predictions/svm_15min_summer_xval.txt trip_start_hr_15 svm_15min_summer | tee svm_15min_summer/perf.txt
